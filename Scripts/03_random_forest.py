...
# buat class oop untuk menjalankan model random forest 
class RandomForestTrainer:
    def __init__(self, data_dir, feature_columns, target_column, hyperparameters, output_dir):
        self.data = data_dir                        # Direktori data
        self.features_columns = feature_columns     # Fitur yang akan digunakan
        self.target_column = target_column          # Target 
        self.hyperparameters = hyperparameters      # Hyperparameter terbaik 
        self.output_dir = output_dir                # Direktori untuk menyimpan model dan hasil evaluasi 
    ...
    def select_features(self, data):
        '''Memilih fitur (x) dan target (y) dari datasheet.'''
        X = data[self.features_columns]
    ...
    def train_model(self, X_train, y_train):
        ...
        print('Model training complated.')
    
    def evaluate_model(self, X, y, dataset_name):
        '''Evaluasi model pada datasheet tertentu dan cetak hasilnya'''
    ...
    def save_model(self):
        ...
        joblib.dumb(self.model, model_path)
        print(f'Modelsaved to {model_path}')
    ...
    def run(self):
        ...
        X_valid, y_vlaid = self.select_features(self.valid_data)
